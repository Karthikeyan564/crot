...
def main():    
    sw_results, sw_results_count = read_results("../testcase_raws/top_testcases_sw_output.txt")
    hw_results, hw_results_count = read_results("../testcase_raws/top_testcases_hw_output.txt")
    
    fd_tests_summary = open("../testcase_raws/top_testcases_summary.txt", "w")
